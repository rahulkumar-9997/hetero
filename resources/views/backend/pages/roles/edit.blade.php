    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4 class="fw-bold">Редактировать роль: {{ ucfirst($role->name) }}</h4>
            </div>
        </div>
        <div class="page-btn">
           ...
           <form action="{{ route('roles.update', $role->id) }}" method="POST" id="roleForm">
                ...
                <div class="form-group mb-4">
                    ...
                    @if(in_array($role->name, ['admin', 'super-admin']))
                        <div class="system-role-warning mt-2">
                            <i class="fa fa-info-circle"></i> Название системной роли изменить нельзя
                        </div>
                    @endif
                    @error('name')
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fa fa-save"></i> Обновить роль
                    </button>
