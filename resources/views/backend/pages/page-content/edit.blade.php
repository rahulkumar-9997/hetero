...
<div class="content">
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4 class="fw-bold">Редактировать страницу</h4>
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
            <a href="{{ url()->previous() }}" data-title="Вернуться на предыдущую страницу" data-bs-toggle="tooltip" class="btn btn-sm btn-purple" data-bs-original-title="Вернуться на предыдущую страницу">
                &lt;&lt; Вернуться на предыдущую страницу
            </a>

        </div>
        <div class="accordion-body border-top">
            <form action="{{ isset($page) ? route('pages.update', $page) : route('pages.store') }}" method="POST" enctype="multipart/form-data" id="editPageForm">
                @csrf
                @if(isset($page))
                @method('PUT')
                @endif
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <div class="mb-3">
                            <label class="form-label">Заголовок страницы<span class="text-danger ms-1">*</span></label>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control" name="page_short_content" id="page_short_content">{{ old('page_short_content', $page->page_short_content ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="d-flex align-items-center justify-content-end mb-4">
                            ...
                            <button type="submit" class="btn btn-primary">{{ isset($page) ? 'Обновить страницу' : 'Добавить страницу' }}</button>
                        </div>
                    </div>
                </div>
            </form>
