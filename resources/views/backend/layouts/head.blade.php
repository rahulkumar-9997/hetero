...
<link rel="stylesheet" href="{{asset('backend/assets/plugins/toastr/toastify.min.css')}}?v={{ env('ASSET_VERSION', '1.0') }}">
<link rel="stylesheet" href="{{asset('backend/assets/css/style.css')}}?v={{ env('ASSET_VERSION', '1.0') }}">
@stack('styles')
